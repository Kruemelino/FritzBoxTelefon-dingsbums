    ...
    <Serializable(), XmlType("person")> Public Class FritzBoxXMLPerson
        ...
        <XmlIgnore> Friend ReadOnly Property CompleteImageURL(Optional SessionID As String = FritzBoxDefault.DfltFritzBoxSessionID) As String
            Get
                ...
                Return If(SessionID.AreNotEqual(FritzBoxDefault.DfltFritzBoxSessionID), $"https://{XMLData.POptionen.ValidFBAdr}:{TR064.DfltTR064PortSSL}/download.lua?path={ImageURL}&{SessionID}", DfltStringEmpty)
            End Get
