...
#Region "Fritz!Box SOAP/TR64"
        ...
        ''' </summary>
        Friend ReadOnly Property DfltTR064RequestNameSpaceEnvelope() As String = "http://schemas.xmlsoap.org/soap/envelope/"
        ''' <summary>
        ''' nameSpace URL: http://schemas.xmlsoap.org/soap/encoding/
        ''' </summary>
        Friend ReadOnly Property DfltTR064RequestNameSpaceEncoding() As String = "http://schemas.xmlsoap.org/soap/encoding/"
