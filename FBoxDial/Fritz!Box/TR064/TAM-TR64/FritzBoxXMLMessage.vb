    ...
    <XmlIgnore> Friend ReadOnly Property CompleteURL(Optional SessionID As String = FritzBoxDefault.DfltFritzBoxSessionID) As String
        Get
            ...
            End If
                ...
                Return If(SessionID.AreNotEqual(FritzBoxDefault.DfltFritzBoxSessionID), $"https://{XMLData.POptionen.ValidFBAdr}:{SOAP.DfltTR064PortSSL}{Path}&{SessionID}", DfltStringEmpty)
        End Get
