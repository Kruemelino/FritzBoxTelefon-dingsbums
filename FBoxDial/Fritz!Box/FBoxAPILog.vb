...
#Region "Zwei-Faktor Authentication"
    ...
    Public Property AbortAuthentication As Boolean Implements ILogWriter.AbortAuthentication
        Get
    ...
    Public Property AuthenticationSuccesful As Boolean Implements ILogWriter.AuthenticationSuccesful
        Get
