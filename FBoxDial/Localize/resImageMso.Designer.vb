...
Public Class resImageMso
    ...
    Public Shared ReadOnly Property IndexTest_ImageMso() As String
        Get
            Return ResourceManager.GetString("IndexTest_ImageMso", resourceCulture)
        End Get
    End Property
    ...
    '''<summary>
    '''  Sucht eine lokalisierte Zeichenfolge, die RmsNavigationBarHome ähnelt.
    '''</summary>
    Public Shared ReadOnly Property mmFBox_ImageMso() As String
        Get
            Return ResourceManager.GetString("mmFBox_ImageMso", resourceCulture)
        End Get
    End Property
