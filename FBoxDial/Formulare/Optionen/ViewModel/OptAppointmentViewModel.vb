...
Public Class OptAppointmentViewModel
    Inherits NotifyBase
    Implements IPageViewModel

    Private Property DatenService As IOptionenService

    Private Const Verwendung As OutlookOrdnerVerwendung = OutlookOrdnerVerwendung.TerminSpeichern
    Private Const ItemType As OlItemType = OlItemType.olAppointmentItem
...
#Region "Felder"
    ...
    Public ReadOnly Property Name As String Implements IPageViewModel.Name
        Get
            Return Localize.LocOptionen.strAppointment
        End Get
    End Property
