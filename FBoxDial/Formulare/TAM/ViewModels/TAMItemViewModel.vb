...
#End Region
    ...
    Public Sub New(dataService As ITAMService, cTAM As TAMItem)
        ' Interface
        ...
        If CurrentTAM.MessageList IsNot Nothing Then
            ...
            MessageListe.AddRange(CurrentTAM.MessageList.Messages.Select(Function(ABM) New TAMMessageViewModel(DatenService) With {.CurrentMessage = ABM,
                                                                                                                                   .TAMVM = Me}))
        End If
    End Sub
