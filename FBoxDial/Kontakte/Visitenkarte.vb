...
Friend Module Visitenkarte
    ...
    ''' <param name="Kontakt">Ziel: (Rückgabe) Der Kontakt in den die Informationen der vCard geschrieben werden als <see cref="Outlook.ContactItem"/></param>
