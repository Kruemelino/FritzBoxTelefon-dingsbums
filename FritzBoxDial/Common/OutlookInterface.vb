...
#End Region
    ...
    ' ''' <param name="dataStream">DataStream with Drag and Drop Information</param>
    ...
    '    Friend Function ReadOutlookDnDData(ByVal dataStream As MemoryStream) As MyOleOutlookData
    ...
    '        Dim folderIdHex As String = C_hf.ByteArrayToString(folderId)
    ...
    '        Dim storeIdHex As String = C_hf.ByteArrayToString(storeId)
    ...
    '            Dim entryIdHex As String = C_hf.ByteArrayToString(entryId)
    ...
    '            Dim searchKeyHex As String = C_hf.ByteArrayToString(searchKey)
