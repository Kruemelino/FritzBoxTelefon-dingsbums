...
Public Class Rijndael
    ...
    Public Function EncryptString128Bit(ByVal vstrTextToBeEncrypted As String, ByVal vstrEncryptionKey As String) As String
        ...
        If Not vstrTextToBeEncrypted = DataProvider.P_Def_LeerString And Not vstrTextToBeEncrypted = DataProvider.P_Def_ErrorMinusOne_String And Not vstrEncryptionKey = DataProvider.P_Def_ErrorMinusOne_String Then
